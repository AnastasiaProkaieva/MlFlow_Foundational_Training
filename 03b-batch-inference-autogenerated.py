...
# MAGIC %md
# MAGIC This is an auto-generated notebook to perform batch inference on a Spark DataFrame using a selected model from the model registry. This feature is in preview, and we would greatly appreciate any feedback through this form:
# MAGIC 
# MAGIC ## Instructions:
...
model_name = "telco_churn_ft_anastasia_prokaieva"
...
model_name = "telco_churn_ft_anastasia_prokaieva"
input_table_name = "churn_mlops_anastasia_prokaieva.telco_churn_features_ft_anastasia_prokaieva"
output_table_path = "/FileStore/batch-inference/telco_churn_ft_anastasia_prokaieva"

# COMMAND ----------

# load table as a Spark DataFrame
table = spark.read.table(input_table_name)
...
# MAGIC ```python
# MAGIC output_table = "" # Example: "ml.batch-inference.telco_churn_ft_anastasia_prokaieva"
